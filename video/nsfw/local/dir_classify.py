...
def main(argv):
    ...
    #csv
    target_file = open("./result.csv", "wb")
    ...
    unsafe_count = 0
    middle_count = 0
    image_files = os.listdir(args.input_file)
    for filename in image_files:
            image_data = open(args.input_file + '/' + filename).read()
            ...
            print("filename: %s, score: %f" % (filename, scores[1]))
            open_file_object.writerow([filename, scores[1]])
    target_file.close()
