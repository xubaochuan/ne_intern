...
class search_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'request', (UserProfileServiceRequest, UserProfileServiceRequest.thrift_spec), None, ), # 1
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.request = UserProfileServiceRequest()
...
class search_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (UserProfileServiceResponse, UserProfileServiceResponse.thrift_spec), None, ), # 0
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = UserProfileServiceResponse()
