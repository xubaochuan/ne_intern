...
class search_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'request', (PredictionServiceRequest, PredictionServiceRequest.thrift_spec), None, ), # 1
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.request = PredictionServiceRequest()
...
class search_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (PredictionServiceResponse, PredictionServiceResponse.thrift_spec), None, ), # 0
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = PredictionServiceResponse()
